...
\newcommand{\Alignment}{Chaotic Neutral}
\newcommand{\Player}{Peter}
\newcommand{\Experience}{---}
\newcommand{\ClassLevel}{Bard 12/Sorcerer 1}
...
travel between any two locations in a city twice as fast.}{\hspace{.5em}}\spacer\headedtext{\bfseries}{Bardic Inspiration (d10)}{As a bonus action, give an inspiration die to another creature.
...
your level + charisma modifer (18).}{\hspace{.5em}}\spacer\headedtext{\bfseries}{Actor (partial)}{2/5 towards:
...
1) Aquan.}{\hspace{.5em}}\spacer\headedtext{\bfseries}{Sustained Symbiosis}{When you fail a saving throw, you can choose to expend one of your Hit Dice to roll it and add the number rolled to the saving throw, potentially turning the failure into a success.
If it uses this feature on a death saving throw, you succeed on the save and regain 1 hit point regardless of the number rolled on the d20.
Once you succeed on a saving throw due to this trait, the symbiote can’t use it again until you finish a long rest.}{\hspace{.5em}}}
