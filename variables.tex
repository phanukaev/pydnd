...
\newcommand{\ClassLevel}{Bard 10/Sorcerer 1}
...
your level + charisma modifer (16).}{\hspace{.5em}}\spacer\headedtext{\bfseries}{Actor (partial)}{2/5 towards:
...
If it uses this feature on a death saving throw, you succeed on the save and regain 1 hit point regardless of the number rolled on the d20.}{\hspace{.5em}}}
